 ...
 * the License.
 */
package com.github.christophersmith.summer.mqtt.samples.paho.pubsub.util;
...
{
    private static final long              serialVersionUID = -6844049667387108588L;
    ...
    public CustomZonedDateTimeSerializer(Class<ZonedDateTime> classType)
    {
        super(classType);
    }
